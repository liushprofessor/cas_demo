/**
 * Created on [2020/2/20 14:27] by Administrator
 * <p>
 * 项目名称： cas TODO(项目名称)
 * <p>
...
public class MainTest {
    ...
    public static void main(String[] args)throws Exception {
        ...
        URI uri=new URI("http://127.0.0.1:8191?test=2&test2=3");
        System.out.println(uri.getQuery());
        System.out.println(Test1.class.getName());
        Test1 test1=ReflectUtils.newInstance("com.sunnada.Test1",new Object[0]);
        test1.test();
    	}
}
